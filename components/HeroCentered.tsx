...
export const HeroCentered = ({
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full flex flex-col items-center justify-start pt-20 sm:pt-28 md:pt-36 pb-12 sm:pb-16 md:pb-28 px-4 sm:px-6 bg-[#05180D] overflow-hidden font-satoshi"
    >
      {/* ── Background ── */}
