...
import { ShieldCheck, Mail, ArrowUpRight, Globe } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
              ...
              <div className="lg:col-span-8 space-y-24">
                ...
                {content.map((section: any, idx: number) => (
                  <div key={section._key || idx} className="space-y-6">
                    <div className="flex items-center gap-4 mb-8">
                      <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center text-emerald-400 shadow-sm transition-all hover:border-emerald-400/30">
                ...
                <div className="mt-32 p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent border border-white/20 relative overflow-hidden group text-center shadow-[0_0_60px_rgba(255,255,255,0.05)]">
                  ...
                  <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-emerald-400/[0.01] blur-[100px] pointer-events-none" />
