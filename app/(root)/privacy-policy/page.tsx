...
export default async function PrivacyPolicyPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050505] selection:bg-white/30 text-white" style={{ fontFamily: "'Satoshi', sans-serif" }}>
      ...
      <main className="grow">
        {/* --- LUXURY HERO SECTION --- */}
        <section className="relative pt-44 pb-32 px-6 overflow-hidden bg-[#050505] z-30">
          {/* --- ATMOSPHERIC GLOWS --- */}
          <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] bg-blue-600/[0.15] rounded-full blur-[140px] pointer-events-none z-0" />
          <div className="absolute top-[10%] right-[-10%] w-[600px] h-[600px] bg-purple-500/[0.12] rounded-full blur-[150px] pointer-events-none z-0" />
          ...
          <div className="relative max-w-5xl mx-auto z-40 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-10">
              <ShieldCheck className="w-3 h-3 text-white" />
              <span className="text-white/80 text-[9px] uppercase tracking-[0.3em] font-bold">Privacy Protocol</span>
            </div>
            
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-10">
              {title.split(' ').map((word: string, i: number) => (
                <span key={i} className={i === title.split(' ').length - 1 ? "italic font-normal text-white" : ""}>
                  {word}{' '}
                </span>
              ))}
            </h1>
          ...
          <div className="absolute bottom-0 left-0 w-full h-48 bg-gradient-to-t from-[#050505] via-[#050505] to-transparent pointer-events-none z-20" />
        </section>

        {/* --- EDITORIAL CONTENT SECTION --- */}
        <section className="relative py-24 px-6 bg-[#050505] z-10 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-48 bg-gradient-to-b from-[#050505] via-[#050505] to-transparent pointer-events-none z-20" />

          <div className="absolute top-[10%] left-[-5%] w-[500px] h-[500px] bg-emerald-500/[0.12] blur-[140px] rounded-full pointer-events-none z-0" />
          <div className="absolute bottom-[20%] right-[-5%] w-[600px] h-[600px] bg-blue-600/[0.12] blur-[150px] rounded-full pointer-events-none z-0" />
          ...
          <div className="max-w-6xl mx-auto relative z-30">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
              ...
              <div className="lg:col-span-8 space-y-24">
                ...
                {content.map((section: any, idx: number) => (
                  <div key={section._key || idx} className="space-y-6">
                    <div className="flex items-center gap-4 mb-8">
                      <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center text-white shadow-sm transition-all hover:border-white/30">
                ...
                <div className="mt-32 p-12 rounded-[3.5rem] bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent border border-white/20 relative overflow-hidden group text-center shadow-[0_0_60px_rgba(255,255,255,0.05)]">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-3 h-14 px-10 rounded-full bg-white text-black font-black text-[10px] uppercase tracking-widest hover:bg-white/80 transition-all active:scale-95 relative z-10 shadow-[0_0_30px_rgba(255,255,255,0.1)]"
                  >
          ...
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[#050505] via-[#050505]/80 to-transparent pointer-events-none z-20" />
        </section>
      </main>
    </div>
  );
